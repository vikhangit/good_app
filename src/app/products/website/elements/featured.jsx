...
export default function Featured() {
    ...
    return (
        <div className='bg-indigo-50 bg-opacity-50 px-24 py-20'>
            <div>
                <h1 className='text-3xl font-semibold text-gray-800 text-center'>Marketing Software {"That's"} Easy to Use and Love</h1>
            </div>
            <div className='mt-12'>
                        ...
                        <TabPanel value={"tab1"}>
                            <div className='flex mt-10'>
                                <div className='w-1/4 pr-20'>
                                    <h1 className='text-2xl font-medium text-gray-800'>Tools that help you reach your audience at the right time and place</h1>
                                </div>
                                <div className='w-3/4'>
