...
function Icon({ open }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`${open ? "rotate-90" : ""} w-5 h-5 text-indigo-600 mr-3.5`} strokeWidth={2.5} >
...
export default function FAQs() {
    ...
    return (
        <div className='bg-indigo-50 bg-opacity-50 pt-20 pb-14 px-24'>
                        ...
                        <div key={index}>
                            {
                                ...
                                >
                                    <div
                                        ...
                                        className={`border border-blue-gray-200 mb-4 rounded-sm`}
                                    >
                                        <AccordionHeader
                                            onClick={() => {handleOpen(index, indexChild)}}
                                            className={`border-0 py-5 text-sm font-semibold flex-row-reverse justify-end`}
                                        >
                                            {itemChild.name}
                                        </AccordionHeader>
                                        <AccordionBody>
