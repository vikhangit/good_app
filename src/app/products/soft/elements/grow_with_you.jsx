...
export default function GrowWithYou() {
  ...
  return (
    <div className="px-24 py-20 bg-indigo-50 bg-opacity-50">
      ...
      <div>
        <p className='text-sm font-light text-center px-6 mt-10'>
          CMS tools are subject to limitations. For more detailed information on product packaging and the limits that apply, please see our Product and Services Catalog <Link href="" className="text-indigo-600 hover:underline font-medium" >here</Link> . Price shown in USD and subject to applicable tax.
        </p>
      </div>
