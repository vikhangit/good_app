        ...
        <div className="px-24 pt-6">
            ...
            <div className='mt-10 flex items-center gap-x-12'>
                <div className='basis-1/2'>
                    <Image alt='' src="/images/products/soft/hero.webp" width={0} height={0} sizes='100vw' style={{ width: "100%", height: "100%" }} />

                </div>
                <div className='basis-1/2'>
                    <div className="flex items-center">
                        <Image alt='' src="/images/header/programming.png" width={25} height={25} />
                        <h1 className='text-xl font-medium ml-3'>Soft®</h1>
                    </div>
                    <h1 className='text-4xl fon-semibold mt-6'>Soft Software</h1>
