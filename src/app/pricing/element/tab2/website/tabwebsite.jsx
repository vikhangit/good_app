  ...
  return (
    <div>
      <TabPanel
        ...
        className="flex flex-col items-center pr-8 pl-0"
      >
        <div className="flex items-center w-full bg-indigo-50 py-6 px-4 border border-indigo-600">
          <p className="text-xs  w-full inline-flex items-center">
            <span className="font-semibold mr-6">New customer offer</span>
            CRM Suite Starter is available for new HubSpot customers at an 86%
            discounted price. Buy now for only $18/month.
          </p>
        </div>
